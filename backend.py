...
# =======================================================
model = None
MODEL_PATH = Path(__file__).resolve().parent / "best_cattle_model.pth"

def get_model():
    global model
    if model is None:
        temp_model = models.efficientnet_v2_s(weights=None)
        in_features = temp_model.classifier[1].in_features
        temp_model.classifier[1] = nn.Linear(in_features, num_classes)
...
# =======================================================
# Run Uvicorn for local testing or Render
# =======================================================
